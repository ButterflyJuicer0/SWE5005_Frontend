<template>
  <div class="navbar">
    <div class="statusBox">
      ...
      <span v-else
            class="businessBtn closing">Relaxing</span>
    </div>
    ...
    <div :key="restKey"
      ...
      <div class="rightStatus">
        ...
        <span class="navicon operatingState" @click="handleStatus"><i />Set State</span>
      </div>
    ...
    <!-- 营业状态弹层 -->
    <el-dialog title="Set working state"
      ...
      <span slot="footer"
        ...
        <el-button type="primary"
                   @click="handleSave">Sure</el-button>
      </span>
    </el-dialog>
    <!-- end -->
    <!-- end -->
  ...
  webSocket() {
    ...
    if (typeof WebSocket == 'undefined') {
      ...
      this.websocket.onmessage = function (msg) {
        ...
        that.$notify({
          title: jsonMsg.type === 1 ? 'Ready to accept' : 'Argent',
          duration: 0,
          ...
          message: `${
            jsonMsg.type === 1
              ? `<span>You have one <span style=color:#419EFF>Ready to accept</span>,${jsonMsg.content},Please accept</span>`
              : `${jsonMsg.content}<span style='color:#419EFF;cursor: pointer'>to do</span>`
          }`,
        })
      }
      // 监听socket关闭
